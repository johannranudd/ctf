1. undo -> picoCTF{Revers1ng_t3xt_Tr4nsf0rm@t10ns_dcc1896c}
2. MY GIT -> picoCTF{1mp3rs0n4t4_g17_345y_02a39618}
3. bytemancy 1 -> picoCTF{h0w_m4ny_e's???_446bf6f1}
4. Printer Shares -> picoCTF{5mb_pr1nter_5h4re5_7a400ec3}
5. ping-cmd -> picoCTF{p1nG_c0mm@nd_3xpL0it_su33essFuL_ddce97d3}
6. bytemancy 0 -> picoCTF{pr1n74813_ch4r5_1ade0c44}
7. Piece by Piece -> picoCTF{z1p_and_spl1t_f1l3s_4r3_fun_4e5c49a8}
8. Old Sessions -> picoCTF{s3t_s3ss10n_3xp1rat10n5_53a328ed}
9. SUDO MAKE ME A SANDWICH -> picoCTF{ju57_5ud0_17_d8e1a280}
10. Quizploit -> picoCTF{my_bIn@4y_3xpl0it_fL@g_7e4d85f6}
11. StegoRSA -> picoCTF{rs4_k3y_1n_1mg_d8526dc3}
    1.  2d2d2d2d2d424547494e2050524956415445204b45592d2d2d2d2d0a4d494945765149424144414e42676b71686b6947397730424151454641415343424b63
    2.  -----BEGIN PRIVATE KEY-----
...
-----END PRIVATE KEY-----
    ...
    4. openssl pkeyutl -decrypt -inkey private.pen -in flag.enc
