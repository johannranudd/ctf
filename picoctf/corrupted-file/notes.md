...
## notice:
notice the JFIF in the result.
this indicates that this is a JPEG/JFIF file with broken headers.
...
valid jpg files start with: ``FF D8 FF E0``

## change file:
- change the file extension to .jpg --> file.jpg
- change bytes:
    `printf '\xFF\xD8' | dd of=file.jpg bs=1 seek=0 count=2 conv=notrunc`

## Result:
`
┌──(kali㉿jrpc)-[/mnt/c/Users/johann/documents/picoctf/corrupted-file]
